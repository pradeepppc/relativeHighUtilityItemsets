...
//		        }
	    	...
	    	for (int k = j+1; k < itemsToKeep.size(); k++) {
	        	...
	        	// float subtree_utility_ratio = (float) (utilityBinArraySU[itemk] / utility_sum_pek);
                        // local utility ratio
                        // float localtree_utility_ratio = (float) (utilityBinArrayLU[itemk] / utility_sum_pek);
